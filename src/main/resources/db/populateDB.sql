...
VALUES ('Dish1', 100, '2021-01-01', 100006),
       ...
       ('Dish21', 100, CURDATE(), 100006),
       ('Dish22', 200, CURDATE(),  100006),
       ('Dish23', 300, CURDATE(),  100006),
       ('Dish24', 400, CURDATE(),  100006),
       ('Dish25', 500, CURDATE(),  100006),
       ('Dish26', 600, CURDATE(),  100006),
       ('Dish27', 700, CURDATE(),  100006),
       ('Dish28', 800, CURDATE(),  100006),
       ('Dish29', 900, CURDATE(),  100006),
       ('Dish30', 1000, CURDATE(),  100006),
       ('Dish31', 1100, CURDATE(),  100007),
       ('Dish32', 1200, CURDATE(),  100007),
       ('Dish33', 1300, CURDATE(),  100007),
       ('Dish34', 1400, CURDATE(),  100007),
       ('Dish35', 1500, CURDATE(),  100007),
       ('Dish36', 1600, CURDATE(),  100007),
       ('Dish37', 1700, CURDATE(),  100007),
       ('Dish38', 1800, CURDATE(),  100007),
       ('Dish39', 1900, CURDATE(),  100007),
       ('Dish40', 2000, CURDATE(),  100007);
